                ...
                <tbody>
                    @foreach ($order as $item)
                        @if ($item->id_user == Auth::user()->id)
                            <tr>
                                <td><img src="{{ isset($item->book->URL) ? asset($item->book->URL) : '' }}"
                                        class="img-thumbnail" width="80px" alt=""></td>
                                ...
                                <td>{{ isset($item->customer->created_at) ? \Carbon\Carbon::parse($item->customer->created_at)->format('d-m-Y H:i:s') : '' }}
                                </td>
                            </tr>
                        @elseif ($admin)
                            <tr>
