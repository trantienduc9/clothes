...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('lib/bootstrap-3.4.1-dist/css/bootstrap.min.css') }}">
...
<body>
    <div class="all_css">
        ...
        <nav class="navbar navbar-inverse css_sb">
            <div class="container-fluid" style="display: flex;align-items: center;justify-content: space-between; background: #FFD1DC">
                ...
                <ul class="nav navbar-nav">
                    ...
                    @endif
                    @if ($admin)
                        <li class="change_url"><a href="{{ route('store') }}" class="css_al">Thêm áo</a></li>
                                ...
                                @foreach ($list_category as $val_category)
                                    <li style="background: #FFD1DC">
                                        <a
                                            ...
                                            style="color: black">{{ $val_category->name }}
                                        </a>
                                    </li>
                                @endforeach
                                <li style="background: #FFD1DC"><a href="{{ route('index') }}" style="color: black">Tất
                                        cả</a></li>
                            </ul>
                            @if (Auth::check())
                                <li>
    ...
    <script src="{{ asset('lib/bootstrap-3.4.1-dist/js/bootstrap.min.js') }}"></script>
    <script src="{{ asset('lib/datatables.min.js') }}"></script>
    {{-- <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js"></script> --}}
    {{-- <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
     --}}
     {{-- <script src="{{ asset('lib/f') }}"></script> --}}
