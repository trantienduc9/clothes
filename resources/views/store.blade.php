    ...
    <div class="container mt-5">
        ...
        <form method="POST" action="{{ route('create') }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="productName">Tên Áo:</label>
                <input type="text" class="form-control" id="productName" name="productName" placeholder="Nhập tên áo"
                    value="{{ isset($books['TenSach']) ? $books['TenSach'] : '' }}">
            </div>
            <div class="form-group">
                <label for="author">Hãng:</label>
                <input type="text" class="form-control" id="author" name="author" placeholder="Nhập tên hãng"
                    value="{{ isset($books['TacGia']) ? $books['TacGia'] : '' }}">
            </div>
            <div class="form-group">
                <label for="price">Giá:</label>
                <input type="number" class="form-control" id="price" name="price" placeholder="Nhập giá áo"
                    value="{{ isset($books['Gia']) ? $books['Gia'] : '' }}">
            </div>
            <div class="form-group">
                <label for="quantity">Số Lượng:</label>
                <input type="number" class="form-control" id="quantity" name="quantity" placeholder="Nhập số lượng áo"
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="description" rows="3" name="description" placeholder="Nhập mô tả áo">{{ isset($books['MoTa']) ? $books['MoTa'] : '' }}</textarea>
            </div>
            <div class="form-group">
                <label for="image">Ảnh Áo:</label>
